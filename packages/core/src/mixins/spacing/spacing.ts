...
type DefaultThemeSpacingName = DefaultTheme extends {spacings: SpacingMap<infer SpacingName>} ? SpacingName : DefaultSpacingName;

const getSpacingMap: GetSpacingMapFunction<DefaultThemeSpacingName, DefaultTheme> = theme => {
...
export const paddingBottom = createPaddingBottom({map, spacings: getSpacingMap});
